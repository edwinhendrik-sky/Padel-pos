...
app.post('/api/member', async (req, res) => {
  ...
  try {
    await pool.query(`
      ...
      ON CONFLICT (id_member) DO UPDATE SET 
        nama = EXCLUDED.nama, no_hp = EXCLUDED.no_hp, status_membership = EXCLUDED.status_membership,
        start_member = EXCLUDED.start_member, stop_member = EXCLUDED.stop_member,
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`🚀 Server Admin & Karyawan Aktif di Port ${PORT}`);
});